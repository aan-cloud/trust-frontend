...
export const UserCart: React.FC<ModalProps> = ({ isOpen, ref }) => {
  ...
  return (
    <Card ref={ref} className={isOpen ? "w-fit fixed top-14 right-24 z-50 shadow-xl" : "hidden"}>
      <CardContent className="p-4">
        <nav className="flex flex-col space-y-2">
          <Button onClick={() => router.push("/user")} variant="ghost" className="justify-start pl-1 font-semibold font-poppins ">
