    ...
    <section className="flex justify-between px-28 bg-[#272727] py-6 text-white">
      <div className="flex flex-col gap-5">
        ...
        <ul className="max-w-64 flex flex-col gap-2">
          ...
          <li>
            No 30E, Jalan Dinar F U3/F, Taman Subang Perdana, Seksyen U3, 40150
      ...
      <div className="flex flex-col gap-5">
        <h1 className="text-theme-1 text-2xl font-bold">
        ...
        <div className="flex gap-3" id="medsos">
          ...
          <img
            width="50"
            height="50"
            src="https://img.icons8.com/glyph-neue/64/FA5252/instagram-new--v1.png"
